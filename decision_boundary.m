...
min_q=2;
min_C=0.1;
[b_1,Z_SV_1,X_SV_1,Y_SV_1]=SVM(X1,Y1,min_C,'polynomial',min_q);
        K3=kernel(X_SV_1,xy,min_q,'polynomial');
        idx=sign((Z_SV_1.*Y_SV_1)'*K3+b_1)';
...
temp1 = test_data((test_data(:,end)==-1),:);
temp2 = test_data((test_data(:,end)==1),:);
